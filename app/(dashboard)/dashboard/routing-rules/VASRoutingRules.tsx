...
// Props interface
interface VASRoutingRulesProps {
...
const VASRoutingRules: React.FC<VASRoutingRulesProps> = ({
    isAddModalOpen = false,
    setIsAddModalOpen
}) => {
    const [routingRules, setRoutingRules] = useState(vasRoutingData);
    ...
    const handleDelete = (item: RoutingRule) => {
        console.log("Deleting VAS rule:", item);
    ...
    const handleSettings = (item: RoutingRule) => {
        console.log("Opening settings for VAS rule:", item);
    ...
    const handleSaveRoutingRule = (data: RoutingRuleFormData) => {
        ...
        console.log("New VAS routing rule created:", newRule);
    };
        ...
        <>
            ...
            <ViewRoutingRuleModal
                ...
                onDeactivate={(rule) => {
                    setViewModalOpen(false);
                    setSelectedRule(null);
                    console.log("Deactivating VAS rule:", rule);
                }}
            />
        </>
    );
